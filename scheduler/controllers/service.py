...
def create_service_berry(service_id, environment_id, name, typ,
        time_mode=BerryModel.TIME_MODE_NOW, dt_start=None, input_params={}, operator=None):
    '''
    创建任务
    '''
    query = {
    ...
    berry_obj = base_ctl.create_obj(ServiceBerryModel, data)
