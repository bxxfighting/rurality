...
urlpatterns = [
    ...
    path('project/department/create/', project_api.CreateProjectDepartmentApi.as_view()),
    path('project/department/delete/', project_api.DeleteProjectDepartmentApi.as_view()),
    path('project/department/list/', project_api.ListProjectDepartmentApi.as_view()),
